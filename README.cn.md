...
[![x-cmd/install — capstone Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/capstone.svg?lang=zh)](https://x-cmd.com/install/capstone)
...
合计: **2,668,646** 行代码（覆盖前 5 种语言、共 **3552** 个文件）。
...
- **最新版本**: `6.0.0-Alpha11` (2026-09-21)
- **最近提交**: 2026-09-21
- **Release 含资产**: 5 个

## 流行度

- **Star**: 9,032 · **Fork**: 1,731 · **开放 issue**: 1,438 · **贡献者**: 319

## 累计统计

- **发布数**: 49 · **已合并 PR**: 1337 · **开放 PR**: 17 · **已关闭 issue**: 1099 · **开放 issue**: 339 · **提交数**: 5485
...
_数据快照: `data/card/260924.yml` · 2026-09-24T04:46:41Z._
