...
[![x-cmd/install — capstone Code Quality Monitoring Repo Card](https://repo.x-cmd.io/capstone.svg?lang=zh)](https://x-cmd.com/install/capstone)
...
- **Star**: 9,032 · **Fork**: 1,729 · **开放 issue**: 1,438 · **贡献者**: 319

## 累计统计

- **发布数**: 49 · **已合并 PR**: 1337 · **开放 PR**: 14 · **已关闭 issue**: 1099 · **开放 issue**: 339 · **提交数**: 5485
...
_数据快照: `data/card/260922.yml` · 2026-09-22T05:01:29Z._
